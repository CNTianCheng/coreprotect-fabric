...
public final class LookupService {
    ...
    public static boolean isBlockAction(String action) {
        if (VALID_ACTIONS.contains(action)) return false;
    ...
    public static int run(ServerCommandSource source, Criteria c) {
        ...
        for (String row : rows) {
            Messages.send(source, net.minecraft.text.Text.literal(row)
    ...
    public static List<String> formatBlockRows(ServerCommandSource source, List<DatabaseManager.BlockLog> logs, int startIndex) {
        List<String> rows = new ArrayList<>();
    ...
    public static List<String> formatContainerRows(ServerCommandSource source, List<DatabaseManager.ContainerLog> logs, int startIndex) {
        List<String> rows = new ArrayList<>();
        Translator t = CoreProtectFabric.instance().translator();
        ServerPlayerEntity p = source.getPlayer();
        long now = TimeUtil.now();
    ...
    public static List<String> formatEntityRows(ServerCommandSource source, List<DatabaseManager.EntityLog> logs, int startIndex) {
        List<String> rows = new ArrayList<>();
        Translator t = CoreProtectFabric.instance().translator();
        ServerPlayerEntity p = source.getPlayer();
        long now = TimeUtil.now();
    ...
    public static List<String> formatSessionRows(ServerCommandSource source, List<DatabaseManager.MessageLog> logs, int startIndex) {
        List<String> rows = new ArrayList<>();
        Translator t = CoreProtectFabric.instance().translator();
        ServerPlayerEntity p = source.getPlayer();
        long now = TimeUtil.now();
    ...
    public static List<String> formatMessageRows(ServerCommandSource source, List<DatabaseManager.MessageLog> logs,
