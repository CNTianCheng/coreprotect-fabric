...
public final class TimeUtil {
     ...
     */
    public static String ago(Translator t, ServerPlayerEntity player, long secondsAgo) {
    ...
    public static String formatDuration(Translator t, ServerPlayerEntity player, long seconds) {        long w = seconds / 604800;
