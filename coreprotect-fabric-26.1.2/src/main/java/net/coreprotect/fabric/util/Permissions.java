...
public final class Permissions {
    ...
    public static boolean has(CommandSourceStack source, String node) {
        ...
        if (Commands.hasPermission(levelCheck(required)).test(source)) return true;
