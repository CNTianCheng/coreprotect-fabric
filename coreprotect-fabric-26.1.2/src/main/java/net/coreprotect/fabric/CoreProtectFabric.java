...
public final class CoreProtectFabric implements ModInitializer {
    ...
    /**
     * Natural causes that reach us through {@code Level#setBlock} (explosions,
     * endermen, pistons, fluids). Causes that reach us through
     * {@code destroyBlock}/{@code removeBlock} (fire, leaf decay) are in
     * {@link #BREAK_CAUSES}.
     */
