...
public final class CoCommand {
    ...
    public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
        ...
        Predicate<ServerCommandSource> lookupLevel = s -> s.hasPermissionLevel(perm.lookupLevel);
        Predicate<ServerCommandSource> adminLevel = s -> s.hasPermissionLevel(perm.adminLevel);
    ...
    private static int languageSet(ServerCommandSource source, String code) {
        ...
        if (code.equalsIgnoreCase("auto") || code.equalsIgnoreCase("default")) {
            ...
            mod.database().saveUserLanguageAsync(p.getGameProfile().getName(), null);
        ...
        mod.database().saveUserLanguageAsync(p.getGameProfile().getName(), code);
